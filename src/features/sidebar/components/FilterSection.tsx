    ...
    >
      <div className="bg-sbSection/60 dark:bg-sbSection-dark/60 border-muted/40 dark:border-muted-dark/40 rounded-lg border p-4">
        <div className="mb-4 flex gap-2">
          <button
            onClick={selectAll}
            className="bg-selectButton hover:bg-selectButton/90 flex-1 rounded-md px-3 py-2 text-xs font-medium text-sbSelectText dark:text-sbSelectText-dark active:scale-95"
          >
            Select all
          </button>
          <button
            onClick={clearAll}
            className="bg-clearButton text-sbClearText hover:bg-clearButton/70 dark:bg-clearButton-dark dark:text-sbClearText-dark dark:hover:bg-clearButton-dark/70 flex-1 rounded-md px-3 py-2 text-xs font-medium active:scale-95"
          >
            Clear all
          </button>
        </div>
            ...
            return (
              <label
                ...
                className={`flex cursor-pointer items-center gap-3 rounded-lg border p-3 transition-colors ${
                  checked
                    ? 'bg-sbCheckboxFiller/10 border-sbCheckboxFiller'
              ...
              >
                ...
                <span
                  className={`flex-1 text-sm font-medium ${checked ? 'text-sbCheckboxFiller' : 'text-sbText/70 dark:text-sbText-dark/70'}`}
                >
                  {i || 'No label'}
                </span>
              </label>
