      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="border-muted/40 bg-sbBackground text-text focus:ring-sbActive dark:bg-sbBackground-dark dark:border-muted-dark/40 dark:text-text-dark w-full rounded-lg border px-3 py-2 text-sm focus:ring-2 focus:outline-none"
          />
        </div>
        ...
        <div>
          <label className="mb-2 block text-sbText dark:text-sbText-dark text-xs font-medium">Date format</label>
